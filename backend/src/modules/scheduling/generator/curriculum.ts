...
export const CS_CURRICULUM: CurriculumCourse[] = [
    ...
    { courseCode: "CSC 210", courseTitle: "C++ Programming", credits: 3, prerequisites: [], corequisites: ["ENG 100", "CSC 210L"], type: 'Major', year: 1, semester: 1 },
    ...
    { courseCode: "EEE 225", courseTitle: "Digital Logic Design", credits: 3, prerequisites: [], corequisites: ["ENG 100", "MAT 213", "EEE 225L"], type: 'Major', year: 1, semester: 2 },
    ...
    { courseCode: "COE 360", courseTitle: "Computer Networks", credits: 3, prerequisites: ["CSC 210"], corequisites: ["COE 360L"], type: 'Major', year: 2, semester: 1 },
    ...
    // --- Year 2 : Semester 2 ---
    { courseCode: "CSC 330", courseTitle: "Database Systems", credits: 3, prerequisites: ["CSC 320"], corequisites: ["CSC 330L"], type: 'Major', year: 2, semester: 2 },
    ...
    // --- Year 2 : Summer ---
    { courseCode: "CSC 497", courseTitle: "Practical Training", credits: 3, prerequisites: ["CSC 320", "CSC 330"], corequisites: [], type: 'Major', year: 2, semester: 3 },
    ...
    { courseCode: "CSC 498", courseTitle: "Capstone Project Proposal", credits: 0, prerequisites: ["CSC 320", "CSC 330"], corequisites: ["CSC 470"], type: 'Major', year: 3, semester: 1 },
